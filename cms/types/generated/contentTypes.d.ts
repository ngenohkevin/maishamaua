...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Product categories for bouquets and arrangements';
...
export interface ApiGalleryImageGalleryImage
  ...
  info: {
    description: 'Images for the gallery showcase';
  ...
  attributes: {
    ...
    galleryCategory: Schema.Attribute.Enumeration<
      ['weddings', 'events', 'daily', 'special', 'arrangements']
    > &
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Bouquets and flower arrangements';
    displayName: 'Product';
    pluralName: 'products';
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    customOrder: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
...
export interface ApiSiteSettingSiteSetting extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    businessName: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'Maisha Maua'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Text;
    ...
    heroTitle: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'Beautiful Flowers for Every Moment'>;
    ...
    philosophyContent: Schema.Attribute.RichText;
    philosophyImage: Schema.Attribute.Media<'images'>;
    philosophyTitle: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'Our Philosophy'>;
    phone: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    tagline: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'Fresh Flowers for Every Occasion'>;
